...
### Re-initialize Git for your own repository

If this code was copied from another repository and you want to publish it as your own independent repository:
